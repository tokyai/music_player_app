...
public class SSDtsEffectItem extends SSRecommendItem {
    public static final Parcelable.Creator<SSDtsEffectItem> CREATOR = new Parcelable.Creator<SSDtsEffectItem>() {
        @Override
        public SSDtsEffectItem createFromParcel(Parcel parcel) {
            return new SSDtsEffectItem(parcel);
        }

        @Override
        public SSDtsEffectItem[] newArray(int i10) {
            return new SSDtsEffectItem[i10];
        }
    };

    public String SSDtsEffectItem() {
        return String.valueOf(this.type) + this.f10114id;
    }

    public SSDtsEffectItem(int i10, int i11, String str, String[] strArr, String str2, String str3, String str4, String str5, String str6, long[] jArr, String str7, String str8, String str9, String[] strArr2, String str10, String str11, String str12, int i12, String str13, int i13, boolean z10, boolean z11, String str14, String str15) {
    ...
    private SSDtsEffectItem(Parcel parcel) {
        super(parcel);
    }
}
